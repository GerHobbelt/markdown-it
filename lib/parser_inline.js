...
import { preProcess } from './rules_inline/linkify.js';
import { tokenize } from './rules_inline/linkify.js';
...
import { tokenize as tokenize$0 } from './rules_inline/strikethrough.js';
import { tokenize as tokenize$1 } from './rules_inline/emphasis.js';
...
import { postProcess } from './rules_inline/strikethrough.js';
import { postProcess as postProcess$0 } from './rules_inline/emphasis.js';
import { postProcess as postProcess$1 } from './rules_inline/linkify.js';
...
const _rules = [
  ...
  [ 'escape', escape ],
  [ 'backticks', backticks ],
  [ 'strikethrough', { tokenize: tokenize$0 }.tokenize ],
  [ 'emphasis', { tokenize: tokenize$1 }.tokenize ],
  [ 'link', link ],
  [ 'image', image ],
  [ 'autolink', autolink ],
...
const _rules2 = [
  ...
  [ 'strikethrough', { postProcess }.postProcess ],
  [ 'emphasis', { postProcess: postProcess$0 }.postProcess ],
  [ 'linkify', { postProcess: postProcess$1 }.postProcess ],
